...
public class CircleRecyclerView extends RecyclerView implements View.OnClickListener {
    ...
    private OnCenterSelectedListener mCenterSelectedListener;
...
//            scrollToPosition(DEFAULT_SELECTION);
        ...
        if (state == SCROLL_STATE_IDLE) {
            if (mNeedCenterForce && !mIsForceCentering) {
                ...
                if (mCurrentCenterChildView != null && mCenterItemClickListener != null)
                    mCurrentCenterChildView.setOnClickListener(this);
                if (mCurrentCenterChildView != null && mCenterSelectedListener != null)
                    mCenterSelectedListener.onCenterSelected(getCenterPosition());
    ...
    public void setOnCenterSelectedListener(OnCenterSelectedListener listener) {
        mCenterSelectedListener = listener;
    }
    ...
    public interface OnCenterSelectedListener {
        void onCenterSelected(int position);
    }
